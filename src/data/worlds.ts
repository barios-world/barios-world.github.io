...
export const WORLDS: Record<number, WorldTheme> = {
  ...
  1: { id: 1, name: 'DER BOULEVARD', sky: '#FFC2DC', horizon: '#FFE0B8', hillFarTint: 0xffffff, hillFarAlpha: 0.55, hillNearTint: 0xffffff, cloudAlpha: 0.9, tiles: 'tiles_w1', track: 'boulevard_calm', ambient: [] },
  2: { id: 2, name: 'BARIOS COFFEE', sky: '#F3E3C9', horizon: '#E8C9A0', hillFarTint: 0xd9b48a, hillFarAlpha: 0.6, hillNearTint: 0x9c6a3c, cloudAlpha: 0.55, tiles: 'tiles_w2', track: 'coffee_calm',
  ...
  3: { id: 3, name: 'CAMBIO', sky: '#1B1330', horizon: '#3A1F52', hillFarTint: 0x6a3a8a, hillFarAlpha: 0.7, hillNearTint: 0x2a5a3a, cloudAlpha: 0.15, tiles: 'tiles_w3', track: 'casino_calm',
